...
python ./scripts/run_benchmark.py \
  ...
  --model-hyper-params '{"anomaly_ratio": 0.1, "batch_size": 64, "d_ff": 256, "d_model": 128, "e_layers": 3, "hybrid_score_lambda": 1e-08, "lr": 0.0001, "n_heads": 8, "n_streams": 6, "num_epochs": 10, "patience": 8, "rvq_gate_floor": 0.3, "rvq_gate_temperature": 6.0, "rvq_grad_scale": 0.2, "rvq_num_embeddings": 64, "score_modes": "recon_stage1", "seq_len": 112, "sinkhorn_iterations": 3}' \
  --gpus "${GPU}" \
  --num-workers 1 \
  --timeout 60000 \
  --seed 2021 \
