...
python ./scripts/run_benchmark.py \
  ...
  --model-hyper-params '{"anomaly_ratio": 1.8, "batch_size": 128, "d_ff": 128, "d_model": 128, "e_layers": 3, "hybrid_score_lambda": 163840.0, "lr": 5e-05, "n_heads": 16, "n_streams": 6, "num_epochs": 5, "patience": 5, "rvq_gate_floor": 0.3, "rvq_gate_temperature": 4.0, "rvq_grad_scale": 0.14, "rvq_num_embeddings": 96, "score_modes": "recon_stage1", "seq_len": 192, "sinkhorn_iterations": 3}' \
  --gpus "${GPU}" \
  --num-workers 1 \
  --timeout 60000 \
  --seed 2021 \
